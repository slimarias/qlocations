    ...
    computed: {
      crudData() {
        return {
          ...
          create: {
            title: this.$tr('qlocations.layout.newPolygon'),
            to: {name: 'qlocations.admin.polygons.create'}
          },
          read: {
            columns: [
          ...
          update: {
            title: this.$tr('qlocations.layout.updatePolygon'),
            to: 'qlocations.admin.polygons.edit'
            //requestParams: {include: 'parent'}
          },
          delete: true,
          /*formLeft: {
